...
public class Kayit {
    ...
    public void kaydet(){
        try {
            ...
            this.stmt.executeUpdate("UPDATE `gladyator`.`oyunlar` SET `Kahramanın_İsmi` = '"+this.kahraman.getIsim()+"', `Kahramanın_Canı` = '"+this.kahraman.getCan()+"', `Kahramanın_Hasarı` = '"+this.kahraman.getHasar()+"',`Kahramanın_Manası` = '"+this.kahraman.getMana()+"', `Kahramanın_Parası` = '"+this.kahraman.getPara()+"', `Kahramanın_Seviyesi` = '"+this.kahraman.getLevel()+"', `Kahramanın_Deneyim_Puanı` = '"+this.kahraman.getDeneyim()+"', `Kahramanın_Kılıcı` = '"+this.kahraman.getKilicIsmi()+"', `Kahramanın_Zırh` = '"+this.kahraman.getZirhIsmi()+"', `Kahramanın_Yetenek` = '"+this.kahraman.getYetenekIsmi()+"', `Kahramanın_Savaş_Durumu` = '"+this.kahraman.getSavasDurumu()+"' WHERE (`idOyunlar` = '"+this.kahraman.getId()+"')");
